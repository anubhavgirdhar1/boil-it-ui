...
Boil It UI is a time-saving, local-first application that helps developers:

- Create project scaffolds visually
- Save them as reusable templates
- Re-use them across projects without copy-pasting old repos
